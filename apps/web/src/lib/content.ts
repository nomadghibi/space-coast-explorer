...
export const destinationPois: DestinationPoi[] = [
  ...
  },
  {
    ...
    description: [
      "Built in 1891 for the Pettee family from New York, this house took over a year to complete — partly because of its ornate interior woodwork, and partly because indoor plumbing was built into the original construction, which was unusual for the time.",
      "The property changed hands many times over the following century. When a developer eventually planned to raze the building, it was saved in 2002 and moved to its current location on Delannoy Avenue by barge from over half a mile south on Rockledge Drive.",
      "Today it operates as the Parrish Grove Inn, a bed and breakfast and wine bar. Its story is a good example of how preservation sometimes requires moving a building entirely rather than leaving it in place."
    ],
  ...
  },
  {
    ...
    description: [
      "Built in the 1880s by dressmaker Julia Roberts, Sur Le Parc is believed to be the oldest surviving wooden commercial building in Historic Cocoa Village. Its name means 'on the park' in French.",
      "Roberts lived on the second floor while leasing the ground floor to some of Cocoa's earliest businesses, including one of the town's first banks. She later opened what may have been Cocoa's first clothing store on the premises, and ran a dressmaking training shop where local girls learned the trade.",
      "The building survived numerous hurricanes and a devastating fire that destroyed nearly every other structure along Delannoy Avenue. Rather than allow it to be demolished, its owner later had it moved and restored. Today it stands on Florida Avenue, west of Cocoa City Hall — look for the distinctive light-blue wooden building.",
      "Source: Central Brevard Mosquito Beaters, Memory Books. Historical photographs courtesy of the State Archives of Florida, Florida Memory, and Stephen Olausen."
    ],
  ...
  },
  {
    ...
    description: [
      "St. Mark's Episcopal Church was built in 1886 and welcomes visitors inside provided no service is in progress. The interior is worth the stop.",
      "The original stained glass windows are dedicated to the early founders of the congregation, who built their community here in the late 1800s. The pews are replicas of the originals, but most of the woodwork throughout the church is still from 1886.",
      "As a visitor stop, the church gives the route a community anchor and helps explain how Cocoa Village is more than commercial history — faith, settlement, and civic life shaped the same streets."
    ],
  ...
  },
  {
    ...
    description: [
      "Built between 1916 and 1920 as a Seventh-day Adventist church, Derby Street Chapel passed through several congregation chapters — sold to the First Church of Christ, Scientist in 1955, then to First Baptist Church of Cocoa in 1964, which still holds ownership today.",
      "Cocoa Main Street holds a 25-year lease on the property and renovated the building to current accessibility standards. It now serves as a venue for weddings, vow renewals, memorials, and small events.",
  ...
  },
  {
    ...
    description: [
      "The Travis family opened their first business in Cocoa in 1885, making S.F. Travis Company the oldest continuously operating business in Cocoa and one of Florida's oldest hardware stores. The current brick building was completed in 1909.",
      "Three Travis brothers originally ran the space with hardware and furniture on one side and dry goods and clothing on the other. The large sidewalk display windows were added during later renovations. Four generations of the family have owned and operated the business — the current owner is the original founder's great-grandson.",
      "The building has never had air conditioning. On a Florida summer afternoon, that fact speaks for itself."
    ],
  ...
  },
  {
    ...
    description: [
      "The Blair Building is one of the recognized historic structures on the official Cocoa Village walking tour. It represents the period when Cocoa was growing from a small Indian River settlement into an established business community.",
      "Detailed primary-source history for this building is still being researched. The stop is included on the route because of its place in the broader commercial fabric of the village — use it to read the block rather than a single building's story."
    ],
    priority: "standard"
  },
  {
...
export const tours: TourDetail[] = [
  {
    ...
    stops: [
      { sequence: 1, slug: "parrish-grove-inn", title: "Parrish Grove Inn / Pette House", summary: "Historic B&B built in 1891 and moved to this location by barge in 2002 — saved from demolition by one of the more unusual preservation stories in Cocoa Village.", visitorStory: "This house was built in 1891 with ornate woodwork and indoor plumbing, which was unusual at the time. It was moved here by barge from Rockledge Drive in 2002 to save it from demolition. The Pettee family from New York were the original owners; today it's a bed and breakfast and wine bar.", internalEditorialState: "ready", coordinateVerificationStatus: "map_verified_provisional", location: { latitude: 28.351836, longitude: -80.724905 }, triggerRadiusMeters: 35, exitRadiusMeters: 60 },
      ...
      { sequence: 3, slug: "sur-le-parc", title: "Sur Le Parc", summary: "The oldest surviving wooden commercial building in Historic Cocoa Village, built in the 1880s by dressmaker Julia Roberts. Its name means 'on the park' in French.", visitorStory: "Look for the light-blue wooden building on Florida Avenue, west of Cocoa City Hall. Built in the 1880s, Julia Roberts lived upstairs while leasing the ground floor to early Cocoa businesses — including one of the town's first banks. She later opened what may have been Cocoa's first clothing store here. The building survived hurricanes and a Delannoy Avenue fire, and was moved to this location to save it from demolition.", internalEditorialState: "ready", coordinateVerificationStatus: "needs_field_verification" },
      { sequence: 4, slug: "st-marks-episcopal-church", title: "St. Mark's Episcopal Church", summary: "Built in 1886, the church welcomes visitors inside when no service is in progress. The original stained glass windows and most of the woodwork are still intact.", visitorStory: "If the door is open, step inside. The stained glass windows are dedicated to the congregation's founders from the late 1800s. The pews are replicas, but most of the woodwork throughout is original from 1886.", internalEditorialState: "ready", coordinateVerificationStatus: "map_verified_provisional", location: { latitude: 28.353367, longitude: -80.724667 }, triggerRadiusMeters: 35, exitRadiusMeters: 60 },
      ...
      { sequence: 6, slug: "derby-street-chapel", title: "Derby Street Chapel", summary: "Built 1916–1920, this chapel passed through three church denominations before Cocoa Main Street renovated it as a small event venue.", visitorStory: "The chapel started as a Seventh-day Adventist church, was sold to Christian Scientists in 1955, then to First Baptist in 1964. Cocoa Main Street holds a 25-year lease and renovated it for events — weddings, memorials, and gatherings. The building shows how historic preservation often depends on finding a new use.", internalEditorialState: "ready", coordinateVerificationStatus: "map_verified_provisional", location: { latitude: 28.3509, longitude: -80.726083 }, triggerRadiusMeters: 35, exitRadiusMeters: 60 },
      { sequence: 7, slug: "sf-travis-company", title: "S.F. Travis & Company", summary: "Cocoa's oldest continuously operating business, founded 1885. The current owner is the original founder's great-grandson. The building has never had air conditioning.", visitorStory: "The Travis family opened here in 1885. The brick building followed in 1909, with hardware and furniture on one side and dry goods and clothing on the other. Four generations later, the great-grandson of the founder still runs the business. It has never had air conditioning — worth noting on a Florida summer afternoon.", internalEditorialState: "ready", coordinateVerificationStatus: "map_verified_provisional", location: { latitude: 28.355783, longitude: -80.7253 }, triggerRadiusMeters: 35, exitRadiusMeters: 60 },
      ...
      { sequence: 9, slug: "blair-building", title: "Blair Building", summary: "One of the historic commercial buildings on the official Cocoa Village walking tour, part of the early business district that grew along the Indian River.", visitorStory: "The Blair Building is part of the commercial fabric that makes the village walkable and historically layered. Detailed primary-source history for this specific building is still being researched — for now, use the stop to read the block: facade proportions, materials, and how the surrounding street evolved.", internalEditorialState: "needs_fact_check", coordinateVerificationStatus: "needs_field_verification" },
